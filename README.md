...
# 📖 [Person's-List!] <a name="about-project"></a>

**[Person's-List!]** is a project to polish my skills.
...
```sh
cd Person-list
git clone git@github.com:malikhaiderkhan/Person-list.git
```
